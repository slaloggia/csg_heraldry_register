...
export default function About() {
    return (
        <div id="about">
            <h2>About Personal Heraldry</h2>
                <p>
                Scholars and Free Scholars of the Chicago Swordplay Guild are permitted to create a heraldic shield design, 
                for display within the Guild Book, as part of their advancement to the rank of Scholar or Free Scholar. 
                This heraldic shield must fit within the guidelines of heraldry laid out for advancing Guilders. 
                Once designed by the Scholar, the shield will be illuminated by one of the Guild book artists: Victor Bayona, Erin Fitzgerald, Heather Hilchey, Rebecca Smith. 
                Additionally, those advancing to the rank of Free Scholar or Provost will be allowed to create a full Heraldic Achievement 
                with their Scholar shield advanced to include a motto, supporters, helm, crest, and mantle. 
                Some additional personalized elements will be permitted for the rank of Provost. 
                <br/>
                Students are responsible for researching and selecting the elements of their Coat of Arms. 
                General resources are provided in the Guild Handbook.
                </p>
            <br/>
            <hr/>
            <h3>Scholars</h3>
                <p>
                Upon obtaining the rank of Scholar, a Scholar may fashion a shield of their own design to be memorialized in the Guild Book. 
                This shield must meet heraldic and reproductive standards, for consistency and re-creation. 
                ...
                <h4>Guidelines</h4>
                    ...
                    <p>
                        Your final design must be simple enough to be reproducible.
                        It should be visually clear regardless of the size of the shield or distance of viewing. 
                        Heraldic rules for the above, must be adhered to. Modern objects as charges are not acceptable for the Coat of Arms project.
                    </p>
                <h4>Process</h4>
                    <ol>
                        <li>Within 30 of playing your prize, you will be added to this page</li>
                        <li>Design your shield
                            <ul>
                        ...
                        <li>When your design is approved, you will get a link to the form to add your Coat of Arms to the digital registry</li>
                    </ol>
